...
//		WebElement iframeElement = driver.findElement(By.cssSelector("iframe[title='Registration']"));
...
//		
//		Assert.assertEquals(driver.findElement(By.cssSelector(".minimal-h2.pull-left")).getText(), "Personal Information");
//	}
}
